...
public class Tester
{
    ...
    public void q5testUniqueIPVistsOnDay() {
        // Create a LogAnalyzer object
        LogAnalyzer analyzer = new LogAnalyzer();
        // Read the data file
        analyzer.readFile("weblog2_log");
    ...
    public void q6testUniqueIPsInRange() {
        // Create a LogAnalyzer object
        LogAnalyzer analyzer = new LogAnalyzer();
        // Read the data file
        analyzer.readFile("weblog2_log");
    ...
    public void q7testMostNumberVisitsByIP() {
        // Create a LogAnalyzer object
        LogAnalyzer analyzer = new LogAnalyzer();
        // Read the data file
        analyzer.readFile("weblog2_log");
    ...
    public void q8testIPsMostVisits() {
        // Create a LogAnalyzer object
        LogAnalyzer analyzer = new LogAnalyzer();
        // Read the data file
        analyzer.readFile("weblog2_log");
    ...
    public void q9testDayWithMostIPVisits() {
        // Create a LogAnalyzer object
        LogAnalyzer analyzer = new LogAnalyzer();
        // Read the data file
        analyzer.readFile("weblog2_log");
    ...
    public void q10testIPsWithMostVisitsOnDay() {
        // Create a LogAnalyzer object
        LogAnalyzer analyzer = new LogAnalyzer();
        // Read the data file
        analyzer.readFile("weblog2_log");
