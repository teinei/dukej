...
public class ParsingWeatherData {
    ...
    public static void q10q11testFileWithColdestTemperature() {
    ...
    public static void q4q5testlowestHumidityInFile() {
        ...
        //
        fr = new FileResource("./2014/weather-2014-07-22.csv");//q5
        smallest = lowestHumidityInFile(fr.getCSVParser());
        System.out.println("Lowest humidity was " + smallest.get("Humidity") +
                   " at " + smallest.get("DateUTC"));
    }
    ...
    public static void q6q7testLowestHumidityInManyFiles() {
    ...
    public static void  q8testAverageTemperatureInFile() { //q8
    ...
    public static void q9testAverageTemperatureWithHighHumidityInFile(){
